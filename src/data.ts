...
export const INITIAL_PROFILES: Profile[] = [
  {
    ...
    location: 'Delhi, IN',
    isUser: true,
    contactUrl: 'mailto:support@skillswap.app'
  },
  {
    id: 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', // Matches seeded uuid
    name: 'Arpit Bhardwaj',
  ...
  {
    id: 'b2c3d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e', // Matches seeded uuid
    name: 'Meera Sen',
  ...
  {
    id: 'c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f', // Matches seeded uuid
    name: 'Chaitanya K.',
  ...
  {
    id: 'd4e5f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a', // Matches seeded uuid
    name: 'Riya Sharma',
  ...
  {
    id: 'e5f6a7b8-c9d0-1e2f-3a4b-5c6d7e8f9a0b', // Matches seeded uuid
    name: 'Devashish Raj',
...
export const INITIAL_TEAMS: StudyTeam[] = [
  ...
  {
    id: '02c3d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e',
  ...
  {
    id: '13d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f',
...
export const INITIAL_MESSAGES: Message[] = [
  {
    id: 'm1',
    swapId: 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d',
    senderId: 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d',
    text: 'Hey! I saw you teach React and want to learn Figma. I would love to swap. I am working on a portfolio website and need some React help.',
    timestamp: '10:14 AM'
  },
  {
    id: 'm2',
  ...
  {
    id: 'm4',
    swapId: 'c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f',
    senderId: 'c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f',
    text: 'Hey, noticed your profile! Let\'s pair up. I can teach you the basics of Rust systems programming, if you can help me understand React states.',
    timestamp: 'Yesterday'
  }
];
